...
public class ReflectUtils {
                ...
                if (args[i] != null && !args[i].getClass().equals(cs[i])) {
                    if (cs[i] == String.class) {
                        ...
                        if (args[i] instanceof String) {
                            ...
                            args[i] = getJavaDate((Double) args[i], false);
                        }
    ...
    public static Date getJavaDate(double date, boolean use1904windowing) {
        Calendar calendar = getJavaCalendar(date, use1904windowing);
    ...
    public static Calendar getJavaCalendar(double date, boolean use1904windowing) {
        if (date <= -4.9E-324D) {
            ...
            calendar = Calendar.getInstance(timeZone, (locale != null ? locale : Locale.getDefault()));
